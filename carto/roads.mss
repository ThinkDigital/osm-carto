...
@trunk-fill: white;
@trunk-fill-alternative: white;
@primary-fill: yellow;
@secondary-fill: green;
@tertiary-fill: black;
@residential-fill: red;
@service-fill: #ffffff;
@living-street-fill: brown;
@pedestrian-fill: grey;
@road-fill: purple;
@path-fill: #89a4cb;
@footway-fill: #f9d6aa;
@steps-fill: #ffffff;
...
@residential-width-z13:           2.3;

@motorway-width-z14:			  7.8;
@primary-width-z14:		  		  5.5;
@secondary-width-z14:			  4.6;
@tertiary-width-z14:              4.1;       
...
@trunk-width-z15:                10.3;
@primary-width-z15:              8.24;
@secondary-width-z15:            4.5;
@tertiary-width-z15:             6.9;
@tertiary-link-width-z15:        6.6;
@residential-width-z15:           4;


@residential-width-z16:          4;      
@secondary-width-z16:			 4;
@service-width-z16:    			6;            
...
@casing-width-z18:                1.1;
@tertiary-link-casing-width-z17:  1.5;


@bridge-casing-width-z9:          0.5;
@bridge-casing-width-z10:         0.5;
@bridge-casing-width-z11:         0.5;
...
.roads-casing, .bridges-casing, .tunnels-casing {
  ...
  ::casing {
	...
	[feature = 'highway_footway'][foot = 'designated'] {
      .bridges-casing {
        [zoom >= 15] {
          line-width: 4.5;
          line-color: @bridge-casing;
...
.roads-fill,.bridges-fill,.tunnels-fill {
  ...
  ::fill {
    ...
    [feature = 'highway_trunk'] {
      [zoom >= 11] {
		[zoom >= 11] { line-width: @motorway-width-z9 - 2 * @casing-width-z9; }
		[zoom >= 12] { line-width: @trunk-width-z12 - 2 * @casing-width-z12; }
        [zoom >= 13] { line-width: @trunk-width-z13 - 2 * @casing-width-z13; }
        [zoom >= 15] { line-width: @trunk-width-z15 - 2 * @casing-width-z15; }
        [zoom >= 17] { line-width: @trunk-width-z17 - 2 * @casing-width-z17; }
        .roads-fill, .bridges-fill {
        ...
        .bridges-fill {
		  [zoom >= 11] { line-width: @motorway-width-z9 - 2 * @bridge-casing-width-z9; }
		  [zoom >= 12] { line-width: @trunk-width-z12 - 2 * @bridge-casing-width-z12; }
          [zoom >= 13] { line-width: @trunk-width-z13 - 2 * @bridge-casing-width-z13; }
          [zoom >= 15] { line-width: @trunk-width-z15 - 2 * @bridge-casing-width-z15; }
          [zoom >= 17] { line-width: @trunk-width-z17 - 2 * @bridge-casing-width-z17; }
        }
    ...
    [feature = 'highway_primary'] {
      [zoom >= 11] {
        ...
        .bridges-fill {
		  ...
		  [zoom >= 12] { line-width: @primary-width-z12 - 2 * @bridge-casing-width-z12; }
          [zoom >= 13] { line-width: @primary-width-z13 - 2 * @bridge-casing-width-z13; }
    ...
    [feature = 'highway_secondary'] {
      [zoom >= 11] {
		...
		[zoom >= 12] { line-width: @secondary-width-z12 - 2 * @casing-width-z12; }
        [zoom >= 13] { line-width: @secondary-width-z13 - 2 * @casing-width-z13; }
        ...
        .bridges-fill {
		  ...
		  [zoom >= 12] { line-width: @secondary-width-z12 - 2 * @bridge-casing-width-z12; }
          [zoom >= 13] { line-width: @secondary-width-z13 - 2 * @bridge-casing-width-z13; }
	...
	[feature = 'highway_tertiary'][zoom >= 12][zoom < 13] {
      line-width: 1;
      line-color: @residential-casing;
    }
    ...
    */
    ...
    [feature = 'highway_track'] {
      [zoom >= 16] {
        ...
        .roads-fill, .tunnels-fill {
          [zoom >= 6]                   { background/line-width: 3; }
          .roads-fill                    { background/line-opacity: 0.4; }
        ...
        line/line-cap: round;
        line/line-join: round;
        [zoom >= 16] { line/line-width: 1.5; }
        .roads-fill, .bridges-fill   { line/line-opacity: 0.8; }
        .tunnels-fill[zoom >= 16]    { line/line-opacity: 0.5; }
